...
;return iter__7088__auto__.call(null,clojure.string.split.call(null,m,"Content-Length"));
})());
});
...
lt.plugins.js.inspect = (function inspect(thing,depth){return lt.plugins.js.util_inspect.call(null,thing,false,(function (){var or__6371__auto__ = depth;if(cljs.core.truth_(or__6371__auto__))
{return or__6371__auto__;
} else
{return 5;
}
...
{var node = (tree.body[0]);if(cljs.core.truth_((function (){var and__6359__auto__ = cljs.core._EQ_.call(null,node.type,"ExpressionStatement");if(and__6359__auto__)
{var and__6359__auto____$1 = node.expression.callee;if(cljs.core.truth_(and__6359__auto____$1))
